      ...
      <div class="col-md-12 col-md-offset-1">
        <div class="card card-default">
          {{-- <div class="card-header">
            <a href="/job-type" class="btn btn-info btn-xs pull-right">
              <i class="fa fa-fw fa-mail-reply" aria-hidden="true"></i>
              <span class="hidden-xs">List Job Type </span><br/>
            </a>
          </div> --}}
          {!! Form::open(array('action' => 'JobTypeController@store', 'method' => 'POST', 'role' => 'form', 'files' => true)) !!}
            {!! csrf_field() !!}
            ...
            <div class="card-body">
              ...
              <div class="form-group has-feedback row {{ $errors->has('comment') ? ' has-error ' : '' }}">
                ...
                <div class="col-md-9">
                  <div class="input-group">
                    {!! Form::textarea('comment', old('comment'), array('id' => 'comment', 'class' => 'form-control col-md-7 col-xs-12', 'placeholder' => trans('Comment'))) !!}
                  </div>
