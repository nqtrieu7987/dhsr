...
<div class="alert alert-danger alert-dismissable fade show" role="alert" style="display: none;" id="error_ajax">
  {{-- <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a> --}}
  <h4>
    <i class="icon fa fa-warning fa-fw" aria-hidden="true"></i>
    Error
...
<div class="alert alert-success alert-dismissable fade show" role="alert" style="display: none;" id="success_ajax">
  {{-- <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a> --}}
  <h4>
    <i class="icon fa fa-warning fa-fw" aria-hidden="true"></i>
    Success
