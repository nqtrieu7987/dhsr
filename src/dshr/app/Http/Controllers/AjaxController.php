...
class AjaxController extends Controller
{
    public function fetch_data(Request $request)
	{
		if($request->ajax())
		{
        	...
        	if($request->type == 'hotel'){
	            ...
	            ->where('old_all_jobs.user_id', $request->id)
	        ...
	        $site = $request->site;
			return view('partials/pagination_data', compact('data','jobType','status','site'))->render();
		}
	}
	...
	public function fetch_ongoing(Request $request)
	{
		if($request->ajax())
		{
	        ...
	        $site = $request->site;
			return view('partials/pagination_ongoing', compact('data','jobType','status','site'))->render();
		}
	}
}
