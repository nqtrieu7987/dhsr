...
@section('content')
    <div _ngcontent-ygg-3="" class="login-page">
        <form method="POST" action="{{ route('register') }}" _ngcontent-ygg-3="" class="ng-untouched ng-pristine ng-valid">
            @csrf
            ...
            <input _ngcontent-ygg-3="" class="btn btn-primary" style="width:300px; text-transform:none; font-size:15px; color:#fff;" type="submit" value="Register" width="500">
        </form>
    </div>
@endsection
