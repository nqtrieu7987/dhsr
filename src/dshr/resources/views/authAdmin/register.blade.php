...
@section('content')
    <div _ngcontent-ygg-3="" class="login-page">
        <form method="POST" action="{{ route('admin.register.submit') }}" _ngcontent-ygg-3="" class="ng-untouched ng-pristine ng-valid">
            ...
            <input _ngcontent-ygg-3="" class="btn btn-primary" style="width:300px; text-transform:none; font-size:15px; color:#fff;" type="submit" value="Register Admin" width="500"><br><br>
