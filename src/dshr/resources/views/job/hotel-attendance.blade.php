...
@section('content')
    <div class="container-fluid">
        <div class="card-body">
            <div class="row">
                <div class="col-12">
                    {!! Form::open(array('route' => 'admin.report.job', 'method' => 'GET', 'class' => 'form-horizontal form-label-left', 'id' => 'reportJob')) !!}
                        <div class="input-group mb-3">
                            <div class="row">
                                {!! Form::label('Job', 'Job', array('class' => 'control-label mt-2 mr-1 ml-2 hidden-xs text-right')); !!}
                                {!! Form::select('job', $jobType, request()->get('job'), ['class' => 'form-control col-md-4 col-xs-6', 'id' =>'job']); !!}

                                {!! Form::label('Date', 'Date', array('class' => 'control-label mt-2 mr-1 ml-2 hidden-xs text-right')); !!}
                                {!! Form::text('start_date', request()->get('start_date'), array('id' => 'datepicker', 'class' => 'form-control col-md-3 col-xs-6 mt-1-sx pull-right datepicker', 'placeholder' => 'dd/mm/yyyy')) !!}
        ...
        @if($check_search == false)
            <h2 class="pl-3 pt-3 pb-3">You have not managed the hotel yet.</h2>
        @else
        <div class="row">
            <div class="col-sm-12">
                <div>
